<footer class="mt-auto w-full max-w-[85rem] py-10 px-4 sm:px-6 lg:px-8 mx-auto">
    <div class="text-center">
        ...
        <div class="flex justify-center items-center">
            <a href="{{ route('home') }}" class="w-4/12 sm:w-2/12 md:w-2/12 lg:w-1/12">
                <img src="{{ asset('assets/images/general/logo.png') }}" alt="Logo Image">
            </a>
        </div>

        {{-- Content --}}
        <div class="mt-3">
            <p class="text-gray-500">&copy; {{ date('Y') }} Mohamad Aldalati. All rights reserved.</p>
            <p class="text-gray-500">Also know as <a
                    class="text-lime-500 decoration-2 hover:underline focus:outline-none focus:underline font-medium"
                    href="https://madnl.nl" target="_blank">MAD NL</a>.</p>
        </div>

        {{-- Github --}}
        <div class="mt-3 space-x-2">
            <a to="https://github.com/mad-hz" target="_blank"
